@extends('default')
@section('content')  
@php use \App\Http\Controllers\DepartamentosController @endphp
<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
			...
			<form role="form" action="{{ url('cadastros/departamentos/editar')}}" class="form" method="post" enctype="multipart/form-data">
