@extends('default')
@section('content')  
@php use \App\Http\Controllers\CategoriasController @endphp
<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
			...
			<form role="form" action="{{ url('cadastros/categorias/editar')}}" class="form" method="post" enctype="multipart/form-data">
