...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div style="color: white;margin-right: 10px;text-transform:capitalize"> 
                
			Loja: 
            {{ strtolower($empresa[0]->id . " - " . $empresa[0]->nome)}}
                </div>
            <!-- Navbar-->
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{ url('usuarios/editar/' .  Auth::user()->username) }}">Meus Dados</a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseConf" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ url('cadastros/empresas') }}"><i class="fas fa-user fa-fw"></i>Empresas/Lojas</a>
                            ...
                            <a class="nav-link" href="{{ url('transportes')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                               Transações
                            </a>
                         ...
                         <div class="sb-sidenav-menu-heading">Atualizações</div>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ url('cadastros/subdepartamentos')}}"><div class="sb-nav-link-icon"><i class="b-nav-link-icon fas fa-table"></i></div>Sub Departamento</a>
                                    <a class="nav-link" href="{{ url('cadastros/categorias')}}"><div class="sb-nav-link-icon"><i class="b-nav-link-icon fas fa-table"></i></div>Categoria</a>
                            ...
                            <div class="collapse" id="collapseConf" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('dados') }}"><i class="fas fa-columns fa-fw"></i>Meus Dados</a>
